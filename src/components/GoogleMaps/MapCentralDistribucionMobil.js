...
import HorariosImagen from "../../images/DisdelZ3.jpg";
...
const MapCentralDistribucionMobil = () => {
  const classes = useStyles();
  const isMobile = useMediaQuery("(max-width: 600px)");

  const handleMapButtonClick = () => {
    window.open("https://maps.app.goo.gl/5WrVKdDpKgaNoQ7i6", "_blank");
  };
          ...
          <Grid item xs={12} lg={4}>
            ...
            <Typography variant="body1" className={classes.scheduleText} align="left">
              <span className={classes.iconText}>
                <LocationIcon className={classes.locationIcon} /> 15 calle 18-08 , Zona 1 <br /> Ciudad de Guatemala
              </span>
            </Typography>
            <Typography variant="body1" className={classes.scheduleText} align="left">
              <span className={classes.iconText}>
...
export default MapCentralDistribucionMobil;
