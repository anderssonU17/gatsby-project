...
const MapCentralDistribucion = () => {
  ...
  const handleMapButtonClick = () => {
    window.open("https://maps.app.goo.gl/c6KzSxapfzVBUfZ88", "_blank");
  };
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} lg={4}>
            <Typography variant="h4" component="h2" gutterBottom align="left">
              Centro de Distribución Y Tienda
            </Typography>
            <br/>
            <Typography variant="body1" className={classes.scheduleText} align="left">
              <span className={classes.iconText}>
                <LocationIcon className={classes.locationIcon} /> 27 calle 1-41, Zona 3 <br /> Ciudad de Guatemala
              </span>
            </Typography>
            <Typography variant="body1" className={classes.scheduleText} align="left">
              <span className={classes.iconText}>
